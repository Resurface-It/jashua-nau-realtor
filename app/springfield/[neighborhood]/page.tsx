...
import {
  springfieldNeighborhoods,
  getNeighborhoodBySlug,
  getNearbyNeighborhoods,
} from '@/lib/neighborhoods'

export async function generateStaticParams() {
  return springfieldNeighborhoods.map((neighborhood) => ({
...
export async function generateMetadata({
  ...
  const neighborhood = getNeighborhoodBySlug(params.neighborhood, 'Springfield')
  ...
  return {
    title: `${neighborhood.name} Homes for Sale in Springfield, Oregon | J.NAU REAL ESTATE`,
    description: `${neighborhood.description} Explore ${neighborhood.name} real estate, schools, and lifestyle in Springfield, OR.`,
  }
}
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://jashua-nau.com/springfield-real-estate',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: neighborhood.name,
        item: `https://jashua-nau.com/springfield/${neighborhood.slug}`,
      },
    ],
  }
        ...
        <Section className="bg-gradient-to-r from-primary to-gray-800 text-white">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              {neighborhood.name} Homes for Sale in Springfield, Oregon
            </h1>
        ...
        <Section>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-xl border border-gray-100">
              <LeadForm
                variant="contact"
                sourcePage={`springfield/${neighborhood.slug}`}
              />
            </div>
          </div>
        </Section>
        ...
        <Section className="bg-secondary">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6">
              ...
              >
                ← Back to Springfield Real Estate
              </Link>
            </div>
